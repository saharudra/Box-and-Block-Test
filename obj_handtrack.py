...
video = cv2.VideoWriter('out.avi',fourcc,25,(1152,848));
...
while 1:
    ...
    print(yellowTotal+greenTotal+total+blueTotal)
...
plt.figure(1)
plt.subplot(311)
plt.plot(frameno , xstore)
plt.subplot(312)
plt.plot(frameno , ystore)
plt.subplot(313)
